...
lowCutSlopeSliderAttachment(audioProcessor.apvts, "LowCut Choice", lowCutSlopeSlider),
highCutSlopeSliderAttachment(audioProcessor.apvts, "HighCut Choice", highCutSlopeSlider)
...
void SimpleEQAudioProcessorEditor::resized()
{
    ...
    lowCutSlopeSlider.setBounds(lowCutArea.removeFromBottom(lowCutArea.getHeight() * .33));
    highCutSlopeSlider.setBounds(highCutArea.removeFromBottom(highCutArea.getHeight() * .33));
